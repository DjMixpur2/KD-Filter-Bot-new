...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002260661088').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001712126409')
...
SPRT_CHNL = environ.get('SPRT_CHNL', 'https://t.me/krbackup')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002260661088')).split()]
