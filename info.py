...
BOT_TOKEN = environ.get('BOT_TOKEN', "6445960862:AAFRkEjXWzVXEZHSYElnoYZZRpjy3nUYVC8")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://telegra.ph/file/f8dfe36912be7dd97aad6.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/f8dfe36912be7dd97aad6.jpg")
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1001655979269')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/sh_moviegroup')
SPRT_CHNL = environ.get('SPRT_CHNL', 'https://t.me/SHBackup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SHBackup')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/SHBackup/11')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', '')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001933509863'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@shbackup')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001878272199')).split()]
